...
>
    ...
    <div 
        ...
        class="fixed inset-0 transform bg-slate-900/40 backdrop-blur-sm transition-all"
        @click="open = false"
    ></div>
    ...
    <div 
        ...
        class="bg-white rounded-2xl overflow-hidden shadow-2xl transform transition-all w-full {{ $maxWidthClass }} border border-slate-200/60 z-10"
    >
        <!-- Modal Header -->
