...
<div 
    ...
    class="flex items-center justify-between p-4 rounded-xl border {{ $classes }} shadow-sm"
>
    ...
    @if($dismissible)
        <button @click="show = false" class="text-slate-400 hover:text-slate-600 transition-colors duration-150">
