<x-app-layout>
    ...
    <x-page-header title="Data Kategori Cacat (NG)" subtitle="Daftar jenis defect / produk non-good untuk operator saat input produksi.">
        <a href="{{ route('master.kategori-ngs.create') }}" class="btn-primary flex items-center gap-2">
    ...
    <!-- Filters Section -->
    <x-filter-section>
        <form method="GET" action="{{ route('master.kategori-ngs.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
            <!-- Search -->
            <x-form-input 
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('master.kategori-ngs.index') }}" class="btn-secondary py-2.5 inline-flex justify-center items-center">
                    Reset
                </a>
            </div>
        </form>
    ...
    <x-card :padding="false">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            @php
                                $badgeColor = match($kategoriNg->severity->value) {
                                    ...
                                    'high' => 'bg-amber-50 text-amber-700 border-amber-250',
                                    'critical' => 'bg-red-50 text-red-700 border-red-250',
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <!-- Edit -->
                                <a href="{{ route('master.kategori-ngs.edit', $kategoriNg->id) }}" 
        ...
        @else
            <div class="p-6">
                ...
                >
                    <a href="{{ route('master.kategori-ngs.create') }}" class="btn-primary btn-sm flex items-center gap-1.5">
